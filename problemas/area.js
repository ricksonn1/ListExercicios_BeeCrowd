...
// Saída
// O arquivo de saída deverá conter 5 linhas de dados. Cada linha corresponde a uma das áreas descritas acima, sempre com mensagem correspondente 
...
const areaDoTriangulo = (a * c) / 2;

const areaDoCiruclo = Math.PI * Math.pow(c, 2)
...
console.log(`CIRCULO = ${areaDoCiruclo.toFixed(3)}`)
